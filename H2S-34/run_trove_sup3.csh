...
#!
$LAUNCH $pwd/$exec < $pwd/input/$name.inp > $pwd/output/$name.out
$LAUNCH /cm/shared/apps/python/intelpython3/bin/python3 $pwd/pickle_xsec.py $pwd/xsec/$xname.xsec
$LAUNCH mv $pwd/xsec/$xname.xsec.pickle $pwd/xsec_combined
