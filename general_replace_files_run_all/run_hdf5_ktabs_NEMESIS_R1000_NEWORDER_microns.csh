...
#!
$LAUNCH /cm/shared/apps/python/intelpython3/bin/python3 $pwd/$exec --dict $pwd/$name --wl 0.3,50 --resolution 1000 --ngauss 20 --ncores 36 --title NEMESIS_final_v1 --key_iso_ll rep1
#!
echo "DONE"
