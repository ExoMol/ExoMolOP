######## Definition dictionary for SiO -- Optimised for cobweb

define = {}

# using exocross
define['software'] = 'exocross'
define['molecule_name'] = 'SiO'
...
if define['platform'] == 'cobweb':
    ...
    define['working_folder'] = 'SiO'
    define['linelist_folder'] = 'linelist/'
    define['tools_folder'] = '/scratch/dp060/dc-yurc1/ExoCross/tools/'
...
define['ranges'] = [(100, 72000)] # 0

define['fullrange'] = [(100,72000)] 


define['full-trans'] = '28Si-16O__SiOUVenIR.trans'

define['trans-files'] = {}
define['trans-files'][0] = ['28Si-16O__SiOUVenIR.trans']

define['state-file'] = '28Si-16O__SiOUVenIR.states'
